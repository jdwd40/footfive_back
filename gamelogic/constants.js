...
const EVENT_TYPES = {
  ...
  KICKOFF: 'kickoff',
  POSSESSION_PLAY: 'possession_play',
  BUILD_UP_PLAY: 'build_up_play',
...
const EVENT_TYPE_TO_CATEGORIES = {
  ...
  [EVENT_TYPES.POSSESSION_PLAY]: ['flow'],
  [EVENT_TYPES.BUILD_UP_PLAY]: ['flow'],
  [EVENT_TYPES.BALL_PROGRESSION]: ['flow'],
