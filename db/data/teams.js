module.exports = [
    ...
    },
    {
        name: "Mega City One",
        players: [
            { name: "J Andrews", attack: 85, defense: 50, isGoalkeeper: false },
            { name: "B Cooper", attack: 82, defense: 52, isGoalkeeper: false },
            { name: "V Lodge", attack: 40, defense: 75, isGoalkeeper: false },
            { name: "C Blossom", attack: 49, defense: 69, isGoalkeeper: false },
            { name: "A Lodge", attack: 40, defense: 77, isGoalkeeper: true }
        ]
    },
    {
        name: "Mega City Two",
        players: [
            { name: "P Adams", attack: 76, defense: 52, isGoalkeeper: false },
            { name: "O Henry", attack: 77, defense: 53, isGoalkeeper: false },
            { name: "L Graham", attack: 85, defense: 70, isGoalkeeper: false },
            { name: "W Scott", attack: 44, defense: 59, isGoalkeeper: false },
            { name: "H James", attack: 45, defense: 72, isGoalkeeper: true }
        ]
    },
    {
        name: "Outside City",
        players: [
            { name: "M White", attack: 78, defense: 53, isGoalkeeper: false },
            { name: "N Brown", attack: 65, defense: 50, isGoalkeeper: false },
            { name: "Q Black", attack: 40, defense: 65, isGoalkeeper: false },
            { name: "R Green", attack: 47, defense: 62, isGoalkeeper: false },
            { name: "S Gray", attack: 50, defense: 75, isGoalkeeper: true }
        ]
    },
    {
        name: "Airway City",
        players: [
            { name: "T Blue", attack: 87, defense: 51, isGoalkeeper: false },
            { name: "U Violet", attack: 86, defense: 50, isGoalkeeper: false },
            { name: "V Indigo", attack: 45, defense: 69, isGoalkeeper: false },
            { name: "W Yellow", attack: 49, defense: 54, isGoalkeeper: false },
            { name: "X Orange", attack: 48, defense: 72, isGoalkeeper: true }
        ]
    },
    {
        name: "Green Bay",
        players: [
            { name: "Y Teal", attack: 70, defense: 35, isGoalkeeper: false },
            { name: "Z Cyan", attack: 88, defense: 53, isGoalkeeper: false },
            { name: "A Magenta", attack: 51, defense: 76, isGoalkeeper: false },
            { name: "B Crimson", attack: 59, defense: 64, isGoalkeeper: false },
            { name: "C Amber", attack: 47, defense: 61, isGoalkeeper: true }
        ]
    },
    {
        name: "Orlean City",
    ...
    ,
    {
        name: "Port Hilo",
        players: [
            { name: "A Blanchard", attack: 70, defense: 15, isGoalkeeper: false },
            { name: "F Hollywood", attack: 72, defense: 17, isGoalkeeper: false },
            { name: "D Derrik", attack: 18, defense: 63, isGoalkeeper: false },
            { name: "A Lefevre", attack: 10, defense: 65, isGoalkeeper: false },
            { name: "M Stevens", attack: 70, defense: 80, isGoalkeeper: true }
        ]
    },
    {
        name: "Virgin City",
    ...
    },
    {
        name: "Tripper City",
        players: [
            { name: "O Arceneaux", attack: 65, defense: 30, isGoalkeeper: false },
            { name: "P Breaux", attack: 67, defense: 42, isGoalkeeper: false },
            { name: "Q Delhomme", attack: 36, defense: 61, isGoalkeeper: false },
            { name: "R Babineaux", attack: 58, defense: 63, isGoalkeeper: false },
            { name: "S Cormier", attack: 68, defense: 78, isGoalkeeper: true }
        ]
    },
    {
        name: "Metro Bay",
