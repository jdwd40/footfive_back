...
// SSE stream
router.get('/events', streamEvents);              // GET /api/live/events?tournamentId=&fixtureId=&category=&afterSeq=
...
// Event history
router.get('/events/recent', getRecentEvents);    // GET /api/live/events/recent?fixtureId=&type=&category=&limit=
